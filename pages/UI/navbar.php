  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
   ...
   " class="nav-link">
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../layout/top-nav-sidebar.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../layout/fixed-topnav.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Navbar</p>
                </a>
              ...
              <li class="nav-item">
                <a href="../layout/fixed-footer.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Fixed Footer</p>
                </a>
   ...
   " class="nav-link">
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../examples/e-commerce.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>E-commerce</p>
                </a>
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../examples/project-add.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Add</p>
                </a>
              ...
              <li class="nav-item">
                <a href="../examples/project-edit.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Edit</p>
                </a>
              ...
              <li class="nav-item">
                <a href="../examples/project-detail.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Project Detail</p>
                </a>
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../examples/forgot-password.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Forgot Password</p>
                </a>
              ...
              <li class="nav-item">
                <a href="../examples/recover-password.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
       ...
       " class="nav-link">
              ...
              <li class="nav-item">
                <a href="../examples/legacy-user-menu.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="../examples/language-menu.php
       " class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Language Menu</p>
                </a>
